...
def run(args):
    ...
    # Instansiate model
    args.num_features = dtu_dataset.features.shape[1]+1 # Path loss model is an additional feature
    args.image_size = [dtu_dataset.image_size[0], dtu_dataset.image_size[1]]
